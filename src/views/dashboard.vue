<template lang='html'>
  <section class='dashboard'>
          ...
          <div class='card-body'>
            <div class='row'>
              <div class='col-lg-3 col-md-6'>
                <div class='d-flex'>
                  <div class='wrapper'>
                    ...
                    <h5 class='mb-0 font-weight-medium text-primary'>Level</h5>
              ...
              <div class='col-lg-3 col-md-6 mt-md-0 mt-4'>
                <div class='d-flex'>
                  <div class='wrapper'>
                    <h3 class='mb-0 font-weight-semibold'>1,236</h3>
                    <h5 class='mb-0 font-weight-medium text-primary'>Points</h5>
              ...
              <div class='col-lg-3 col-md-6 mt-md-0 mt-4'>
                <div class='d-flex'>
                  <div class='wrapper'>
                    <h3 class='mb-0 font-weight-semibold'>768</h3>
                    <h5 class='mb-0 font-weight-medium text-primary'>Challenges</h5>
              ...
              <div class='col-lg-3 col-md-6 mt-md-0 mt-4'>
                <div class='d-flex'>
                  <div class='wrapper'>
                    <h3 class='mb-0 font-weight-semibold'>10,553</h3>
                    <h5 class='mb-0 font-weight-medium text-primary'>Team Score</h5>
                    <p class='mb-0 text-muted'>+138.97(+0.54%)</p>
                  </div>
                  <div class='wrapper my-auto ml-auto ml-lg-4'>
    ...
    </div> <!-------------End of stats bar section--------------->
    <!-------------Start of First 3 Boxes Section --------------->
    <div class="row">
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Chat</h4>
            <p class="card-description">Chat with a sophisticated AI bot or other people.</p>
            <div>
              <img src="../assets/images/ed/chatbot-box.jpg" width=40% alt="Chat Bot" />
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">Fill out fun & simple forms.</p>
            <ul class="list-arrow">
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">Do some activities to take the edge off.</p>
            <ul class="list-star">
              <li>Lorem ipsum dolor sit amet</li>
              <li>Consectetur adipiscing elit</li>
              <li>Integer molestie lorem at massa</li>
    ...
    </div> <!-------------Start of First 3 Boxes Section --------------->
    <!-------------Start of Second 3 Boxes Section --------------->
    <div class="row">
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <ul class="list-ticked">
              <li>101 Ways to Deal With Stress</li>
              <li>Consectetur adipiscing elit</li>
              <li>Integer molestie lorem at massa</li>
              <li>Facilisis in pretium nisl aliquet</li>
              <li>Nulla volutpat aliquam velit></li>
    ...
    </div> <!-------------End of Second 3 Boxes Section --------------->
