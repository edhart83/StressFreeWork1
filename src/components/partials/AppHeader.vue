  ...
  <b-navbar id="template-header" class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row" toggleable="md">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
      <router-link class="navbar-brand brand-logo" to="/">
        <img class="mainLogo123" src="../../assets/images/ed/logo-concept-v2.png" alt="logo" />
      </router-link>
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center ml-auto ml-lg-0">
      ...
      <b-navbar-nav class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
        <b-nav-item class="font-weight-semibold d-none d-lg-block" href="#">Phone: 1-800-123-HELP</b-nav-item>
        ...
        <b-nav-item-dropdown right class="preview-list user-dropdown">
          ...
          <b-dropdown-item>
            <div class="dropdown-header text-center w-100">
              ...
              <p class="mb-1 mt-3 font-weight-semibold">Eddie Banks</p>
              <p class="font-weight-light text-muted mb-0">eddie@gmail.com</p>
            </div>
          </b-dropdown-item>
